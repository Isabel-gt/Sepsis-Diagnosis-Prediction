...
Application of data anlaysis and machine learning to design an end-to end machine learning pipeline for predicting binary outcomes from a real-world dataset.
...
<img width="595" alt="0" src="[https://github.com/Isabel-gt/Sepsis-Diagnosis-Prediction/blob/Main/1.png](https://github.com/Isabel-gt/Sepsis-Diagnosis-Prediction/blob/Main/Images/1.png?raw=true)">
